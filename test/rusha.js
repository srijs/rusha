(function () {
  ...
  describe('Rusha', function() {
    ...
    describe('rawDigest', function() {
      it('returns ArrayBuffer from string', function() {
        assertBytesEqual(
            new Int8Array([0xA9, 0x99, 0x3E, 0x36, 0x47, 0x06, 0x81, 0x6A, 0xBA, 0x3E, 0x25, 0x71, 0x78, 0x50, 0xC2, 0x6C, 0x9C, 0xD0, 0xD8, 0x9D]).buffer,
            r.rawDigest(abcString)
          );
      });
      it('returns ArrayBuffer from buffer', function() {
        assertBytesEqual(
            new Int8Array([0xA9, 0x99, 0x3E, 0x36, 0x47, 0x06, 0x81, 0x6A, 0xBA, 0x3E, 0x25, 0x71, 0x78, 0x50, 0xC2, 0x6C, 0x9C, 0xD0, 0xD8, 0x9D]).buffer,
            r.rawDigest(abcBuffer)
          );
      });
      it('returns ArrayBuffer from array', function() {
        assertBytesEqual(
            new Int8Array([0xA9, 0x99, 0x3E, 0x36, 0x47, 0x06, 0x81, 0x6A, 0xBA, 0x3E, 0x25, 0x71, 0x78, 0x50, 0xC2, 0x6C, 0x9C, 0xD0, 0xD8, 0x9D]).buffer,
            r.rawDigest(abcArray)
          );
      });
      it('returns ArrayBuffer from ArrayBuffer', function() {
        assertBytesEqual(
            new Int8Array([0xA9, 0x99, 0x3E, 0x36, 0x47, 0x06, 0x81, 0x6A, 0xBA, 0x3E, 0x25, 0x71, 0x78, 0x50, 0xC2, 0x6C, 0x9C, 0xD0, 0xD8, 0x9D]).buffer,
            r.rawDigest(abcArrayBuffer)
          );
      });
    });
  });
